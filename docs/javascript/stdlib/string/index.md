...
`match` 方法还可以使用正则表达式作为参数，详见[《正则表达式》一章](../regexp/#字符串的实例方法)
...
`search`方法还可以使用正则表达式作为参数，详见[《正则表达式》一章](../regexp/#字符串的实例方法)
...
`replace` 方法还可以使用正则表达式作为参数，详见[《正则表达式》一章](../regexp/#字符串的实例方法)
...
`split` 方法还可以使用正则表达式作为参数，详见[《正则表达式》一章](../regexp/#字符串的实例方法)
